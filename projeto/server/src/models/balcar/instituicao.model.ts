...
const instituicaoColumnMap = {
    ...
    // O frontend pode enviar { nome: 'Nome da Instituição' }
    nome: 'a.nome',
};
...
const buildInstituicaoQuery = (filters: any) => {
    ...
    const baseQuery = `
        SELECT a.idinstituicao, a.nome
        FROM tbinstituicao a
    `;
...
/**
 * Classe Model para encapsular o acesso a dados da tbinstituicao (Balcar).
 */
