99import React, { useState, useEffect, useMemo } from "react";
        ...
        >
          ...
          {filteredMapReservatorios.map((reservatorio) => {
            ...
            return (
              ...
              >
                <Popup
                  // Aplicando cores de popup do tema neutro
                  style={{ backgroundColor: colors.mapPopupBg, color: colors.mapPopupText }}
                >
                  {imageSrc && (
                    <img
                      src={imageSrc}
