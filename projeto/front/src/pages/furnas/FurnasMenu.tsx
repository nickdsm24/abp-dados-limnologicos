...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="fixed top-0 left-0 h-full w-64 p-6 flex flex-col shadow-xl z-20" style={{ backgroundColor: sidebarBg }}>
...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero */}
      <div className="pt-24 pb-64 px-12 text-center relative overflow-hidden rounded-b-3xl shadow-xl" style={{ backgroundColor: primaryColor }}>
        <div
      ...
      <div className="pt-20 pb-20 text-center bg-gray-50">
