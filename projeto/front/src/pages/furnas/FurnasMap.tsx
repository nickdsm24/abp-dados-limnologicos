...
const SidebarItemFurnas: React.FC<{
  ...
  return (
    ...
    >
      ...
      <p className="text-xs" style={{ color: colors.sidebarTextMuted }}>{infoText}</p>
...
const SidebarFurnas: React.FC<SidebarPropsFurnas> = ({
  ...
  return (
    ...
    >
      ...
      <h2 className="text-xl font-bold mb-1" style={{ color: colors.sidebarText }}>Localizações FURNAS</h2>
      <p className="text-sm" style={{ color: colors.sidebarTextMuted }}>{filteredItems.length} pontos encontrados</p>
      ...
      <div className="flex justify-between space-x-3 mb-4">
        ...
        >
          ...
          <div className={`p-2 rounded-full text-xl mr-2`} style={{ backgroundColor: colors.mapMarkerFurnas, color: 'white' }}>💧</div>
          <div>
        ...
        >
          ...
          <div className={`p-2 rounded-full text-xl mr-2`} style={{ backgroundColor: colors.mapMarkerBalcar, color: 'white' }}>⚙️</div>
          <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            style={{
              ...
              '--tw-ring-color': colors.primary, // (Azul primário)
              '--tw-ring-offset-color': colors.sidebarBg,
            }}
          />
        </div>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="flex space-x-2 p-1 rounded-lg border border-gray-700" style={{ backgroundColor: colors.sidebarItem }}>
            ...
            return (
              ...
              >
                <Popup>
                  ...
                  <h3
                    style={{ color: colors.mapMarkerFurnas }}
          ...
          {filteredMapSitios.map((sitio) =>
            sitio.lat && sitio.lng ? (
              ...
              >
                <Popup>
                  <h3
                    style={{ color: colors.mapMarkerBalcar }}
                    className="font-bold text-lg"
                  >
                    Sítio: {sitio.nome}
                  </h3>
