...
// Lógica dos estilos dos círculos (Mantida)
...
   // 🎯 FUNÇÃO ADAPTADA 
   const handleSelectEstacaoToggle = (id: string) => {
      // Se o item clicado for o mesmo que já está selecionado, deseleciona (volta para "all")
      if (selectedEstacaoId === id) {
         setSelectedEstacaoId("all");
      } else {
         // Caso contrário, seleciona o novo item
         setSelectedEstacaoId(id);
      }
      // Retorna o novo estado (embora setar o estado seja o suficiente para o React)
      return selectedEstacaoId === id ? "all" : id; 
   };
   // ------------------------------------

   // --- Busca de dados da API (Mantida) ---
   useEffect(() => {
...
   // --- Combina Estações com última precipitação (Mantida) ---
...
   // --- Filtro final (com seleção) (Mantido) ---
...
   // --- Centralização dinâmica (Mantida) ---
...
            // 🎯 USO DA FUNÇÃO ADAPTADA
            onSelectEstacao={handleSelectEstacaoToggle}
         />
